...
romimage: file="./bochs/bochs-2.7/bios/BIOS-bochs-latest", address=0x00000000, options=none
vgaromimage: file="./bochs/bochs-2.7/bios/VGABIOS-lgpl-latest"
boot: disk
...
cpu: count=1, ips=4000000, model=pentium, reset_on_triple_fault=1, cpuid_limit_winnt=0, ignore_bad_msrs=1, mwait_is_nop=0
